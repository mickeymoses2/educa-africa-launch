...
const links = [
  ...
  { label: "Ecosystem", to: "/" as const },
  { label: "Solutions", to: "/" as const },
    ...
    >
      <div className="mx-auto max-w-7xl px-5 lg:px-8 flex items-center justify-between gap-6">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <button className="text-sm font-medium text-white/90 hover:text-white px-4 py-2 transition">
            Login
          </button>
          <Link
            to="/school"
      ...
      {open && (
        <div className="lg:hidden mx-5 mt-3 rounded-2xl bg-navy/95 backdrop-blur-md border border-white/10 p-4 space-y-1">
          ...
          <div className="flex gap-2 pt-2 border-t border-white/10 mt-2">
            <button className="flex-1 text-sm font-medium text-white/90 px-4 py-2.5 rounded-lg bg-white/5">
              Login
            </button>
            <Link
              to="/school"
